...
function App() {
  ...
  const fetchAPI = useCallback(async (avoidCache = false) => {
    const api = getAPIURL('top_customers', avoidCache ? `avoid-cache-key=${Math.random() * 100}`: '')
      ...
      <Navbar expand="lg">
        ...
        <div className="mr-auto"/>
          <Form inline onSubmit={(e) => {
            ...
            <Button variant="outline-primary" type="submit">Re fetch</Button>
          </Form>
      </Navbar>
      <Container>
